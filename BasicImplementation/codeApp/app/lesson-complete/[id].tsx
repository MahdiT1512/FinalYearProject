  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.card, { opacity: fade, transform: [{ scale }] }]}>
        ...
        <Text style={styles.subtitle}>Lesson 1 finished</Text>
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: "#0077b6", paddingVertical: 12, paddingHorizontal: 20, borderRadius: 12, width: "100%", alignItems: "center", marginBottom: 10 },
